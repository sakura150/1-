...
namespace CrosswordCreator
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Button2Click(object sender, RoutedEventArgs e)
        {
            ...
            mComboBox.Items.Add(word);

        }

        private void Button2_1Click(object sender, RoutedEventArgs e)
        {
            var word = mComboBox.Text.Trim();
            if (word.Length != 0)
            { 
                _words.Remove(word);
                listView1.Items.Remove(word);
                mComboBox.Items.Remove(word);
            }
        ...
        private void myComboBox(object sender, SelectionChangedEventArgs e)
        {
